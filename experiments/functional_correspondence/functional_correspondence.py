...
pretrain_path = os.path.join(base_path, "pretrained_models/{}_{}.pth".format(args.train_dataset, input_features))
        ...
        for data in tqdm(test_loader):
            ...
            *shape2, name2 = shape2 
            ...
            if with_geodesic_error:
                ...
                errors = diffusion_net.geometry.geodesic_label_errors(verts1, faces1, vts2on1, vts1, normalization='area', geodesic_cache_dir=geodesic_cache_dir)
                
                geodesic_error = toNP(torch.mean(errors))
                geodesic_errors.append(geodesic_error)
                # print(f"geodesic error: {geodesic_error}")
...
if train:
    ...
    for epoch in range(n_epoch):
        ...
        test_loss, test_geodesic_error = test(with_geodesic_error=(epoch % 3 == 0))
