...
# from feature_extractors.diffusion_feature_extractor import DiffusionNetFeatureExtractor
import os
import sys
...
class DiffusionGeomFmaps(nn.Module):
    """Compute the functional map matrix representation."""

    def __init__(self, n_feat=128, n_fmap=30, lambda_=1e-3, input_features="xyz"):
        super().__init__()
